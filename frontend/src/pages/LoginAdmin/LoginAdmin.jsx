...
import bckLogin from '../../assets/background/bckLogin.jpg';
import { Title } from '../../components/Title/Title';
import { FaEye, FaEyeSlash } from 'react-icons/fa';
import useTogglePassword from '../../hooks/useTogglePassword';
import { useDispatch } from 'react-redux';
import { loginAdmin } from '../../redux/Auth/authApi';
...
export const LoginAdmin = () => {
  ...
  const handleLogin = (e) => {
    ...
    loginAdmin(adminData, dispatch, navigate, setErrorMsg);
  };

  return (
    <div
      className="min-h-screen flex items-center justify-center bg-cover"
      style={{ backgroundImage: `url(${bckLogin})` }}
    >
      <div className="bg-white/30 shadow-lg p-6 rounded-lg max-w-md w-full">
        <Title title="Đăng nhập Admin" className="text-center text-2xl text-white  font-semibold mb-12" />
