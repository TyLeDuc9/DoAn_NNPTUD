...
import { deleteBookDetail } from '../../services/bookDetailApi'
...
export const BookDetailAdmin = () => {
  ...
  const handleDelete = async (id) => {
    const confirmDelete = window.confirm("Bạn có chắc muốn xóa chi tiết sách này không?");
    if (!confirmDelete) return;

    try {
      await deleteBookDetail(id);
      alert("Đã xóa chi tiết sách thành công!");
    ...
    <div className="px-4 bg-white min-h-screen">
      ...
      <div className="flex justify-between my-8">
        ...
        <div className="flex">
          ...
          <button
            onClick={() => navigate('/admin/all-booklist')}
            ...
            {books.map((u, idx) => (
              ...
              >
                ...
                <td className={`${tdClass} text-center`}>
                  <div className="flex justify-center">
                    <button
                      onClick={() => handleDelete(u.bookdetail_Id)}
