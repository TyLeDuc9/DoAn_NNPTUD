...
import { createBook, deleteBook } from "../../services/bookApi";
                ...
                >
                  ...
                  <td className={`${tdClass} text-center`}>
                    <button
                      ...
                      className="flex items-center justify-center gap-1 px-3 py-1 rounded-lg bg-red-500 hover:bg-red-600 text-white font-medium transition"
                    >
                      <FaTrash /> Xóa
                    </button>
                  </td>
